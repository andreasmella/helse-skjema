...
"Har du født",
"Har du abortert",
"Skal du til gynekologisk avdeling",
"Trenger du en spesiell type mat",
"Har du behov for hjelpemidler"
            ...
            return (
    "Gjelder dersom du svarer JA på: " +
    parentQuestion
);
        }
...
const section = {
    ...
    headers: firstPageHeaderObj
        ? {
              first: firstPageHeaderObj
          }
        : {},
