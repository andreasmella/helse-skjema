...
(function(){
  ...
  function renderFHIRQuestionnaire(q, Paragraph, TextRun, HeadingLevel, Table, TableRow, TableCell, WidthType) {
...
return paragraphs;
  ...
  async function buildDocxFromJson(jsonObj, logoDataURL, longFieldNames){
    ...
    const { Document, Packer, Paragraph, TextRun, HeadingLevel, ImageRun, Footer, Header, AlignmentType, Table, TableRow, TableCell, WidthType } = window.docx;
